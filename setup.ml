...
(* OASIS_START *)
(* DO NOT EDIT (digest: fbd6f869a1d08841fde5fb4fe5807319) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Pctrl"];
                      lib_pack = false;
                      lib_internal_modules = ["Pctrl_prefix_gen"];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "instrumentation";
                      bs_compiled_object = Best;
                      bs_build_depends = [];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["instrumentation/probe.c"];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "demo1slave.ml"});
               Executable
                 ({
                     cs_name = "demo1master";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "demo1master.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\019\130\134\182\137\132\242\175b\159\134\247?\180@\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
